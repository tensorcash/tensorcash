...
def test_prove_n_weso_and_verify():
    ...
    # Use smaller iterations for CI to avoid timeout
    import os
    if os.environ.get('CI'):
        iter_counts = [10000, 20000, 30000]  # Much smaller for CI
    else:
        iter_counts = [1000000, 5000000, 10000000]  # Original values for full testing
