...
# --------------------------------------------------------------------------- #
#  WARNING: THIS FILE WILL BE OVERWRITTEN BY /shared-utils/confing/constants.py  
#   This file is auto-generated and should not be modified directly.              
# --------------------------------------------------------------------------- #
import torch
import os
from torch.distributions.normal import Normal        # already imported below
...
TEMP_MAX        = 2
ENTROPY_FILT    = .925
REUSE_SCORE_Q32_BITS = 32
REUSE_SCORE_Q32_ONE = 1 << REUSE_SCORE_Q32_BITS
REUSE_SCORE_CAP_Q32 = 247891519322  # ceil(57.716742 * 2^32)
# Proofs with version < REUSE_GATE_VERSION are legacy and grandfathered (the reuse
# gate is a no-op); version >= REUSE_GATE_VERSION are enforced. Mirrors C++.
REUSE_GATE_VERSION = 2
REP_PENALTY     = 0.1
...
SF_DTYPES.update({
    name: dtype for name, dtype in _FP8_SAFETENSORS_DTYPES.items()
